      ...
      <div className="home">
        ...
        <main className="container">
          ...
          <div className={clsx(styles.features, "row")}>
            ...
            <Feature icon="emoji_flags" title="Performance" description="Built from the ground up for performance and scale." />
            <Feature icon="settings_input_component" title="Modular" description="Use or create your own custom modules." />
            <Feature icon="category" title="Organized" description="Better project code organization approach." />

          </div>
          <div className={clsx(styles.features, "row")}>
            <Feature image="img/typescript.svg" title="For TypeScript" description="Built with latest JavaScript features using TypeScript." />
